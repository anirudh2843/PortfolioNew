...
app.post("/api/mail", async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-family: Arial, sans-serif; background: #f4f4f4; padding: 30px;">
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background: #ffffff; border-radius: 8px; border: 1px solid #ddd;">
          <!-- Header -->
          <tr>
